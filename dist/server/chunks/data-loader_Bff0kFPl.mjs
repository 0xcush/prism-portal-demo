...
const firms = [
  ...
  { id: "f2", name: "Schroders", type: "Investment Manager", status: "Active", relationshipStatus: "Active", offices: ["London"], lastInteraction: "2026-03-01", relationshipStart: "2021-09-10", contactCount: 3, referralCount: 4, personalNotes: "Strong relationship through Marcus Thornley. Annual charity lunch.", totalAUM: 152e5, keyContactName: "Marcus Thornley", keyContactTitle: "Head of Charity Investments", advisors: [
  ...
  { id: "f5", name: "Cazenove Capital", type: "Investment Manager", status: "Active", relationshipStatus: "Active", offices: ["London"], lastInteraction: "2026-03-04", relationshipStart: "2023-06-15", contactCount: 2, referralCount: 3, personalNotes: "Edward Langley refers UHNW clients. Quality over quantity.", totalAUM: 321e5, keyContactName: "Edward Langley", keyContactTitle: "Senior Investment Manager", advisors: [
  ...
  { id: "f9", name: "Deloitte Private", type: "Accountancy", status: "Nurturing", relationshipStatus: "Nurturing", offices: ["London", "Manchester"], lastInteraction: "2026-02-15", relationshipStart: "2024-05-10", contactCount: 2, referralCount: 1, personalNotes: "Tax planning referrals. Need to schedule L&L with wider team.", totalAUM: 42e5, keyContactName: "James Whitfield", keyContactTitle: "Tax Director", advisors: [
...
const clientAccounts = [
  { id: "ca1", name: "Cavendish-Hale Foundation Fund", accountNumber: "DAF-2025-0041", accountType: "DAF", entity: "PTGF", status: "Active", cashBalance: 38e4, investmentBalance: 362e4, offshoreBalance: 2e5, totalValue: 42e5, ytdReturn: 7.2, relationshipManager: "James Prescott", onboardedDate: "2025-05-15", impactCategory: "Healthcare", location: "London, UK", ukGifts: 6, overseasGifts: 3, assetTypes: ["Cash", "Shares"], hasInvestmentAccount: true, investmentProvider: "Goldman Sachs", accountManager: "Patricia Gresham", giftEligible: true, donorCount: 1 },
  { id: "ca2", name: "Beaumont Charitable Fund", accountNumber: "DAF-2025-0055", accountType: "DAF", entity: "PTGF", status: "Active", cashBalance: 15e4, investmentBalance: 182e4, offshoreBalance: 0, totalValue: 197e4, ytdReturn: 5.8, relationshipManager: "Victoria Langley", onboardedDate: "2025-08-20", impactCategory: "Healthcare", location: "London, UK", ukGifts: 4, overseasGifts: 0, assetTypes: ["Cash", "Shares"], hasInvestmentAccount: true, investmentProvider: "Schroders", accountManager: "Marcus Thornley", giftEligible: true, donorCount: 1 },
  { id: "ca3", name: "Ellsworth Research Fund", accountNumber: "DAF-2025-0063", accountType: "DAF", entity: "PTGF", status: "Active", cashBalance: 95e3, investmentBalance: 845e3, offshoreBalance: 0, totalValue: 94e4, ytdReturn: 6.1, relationshipManager: "Rachel Whitfield", onboardedDate: "2025-07-10", impactCategory: "Education", location: "Oxford, UK", ukGifts: 5, overseasGifts: 1, assetTypes: ["Cash", "Shares"], hasInvestmentAccount: true, investmentProvider: "JM Finn", accountManager: "Thomas Barrington", giftEligible: true, donorCount: 1 },
  { id: "ca4", name: "Ashworth Arts & Heritage Fund", accountNumber: "DAF-2025-0071", accountType: "DAF", entity: "PTGF", status: "Active", cashBalance: 22e4, investmentBalance: 148e4, offshoreBalance: 0, totalValue: 17e5, ytdReturn: 4.9, relationshipManager: "Rachel Whitfield", onboardedDate: "2025-10-01", impactCategory: "Arts & Culture", location: "London, UK", ukGifts: 7, overseasGifts: 0, assetTypes: ["Cash", "Shares"], hasInvestmentAccount: true, investmentProvider: "Coutts", accountManager: "James Hartington", giftEligible: true, donorCount: 1 },
  { id: "ca5", name: "Kensington Collective Fund", accountNumber: "CF-2024-0012", accountType: "Collective Fund", entity: "TPCT", status: "Active", cashBalance: 12e5, investmentBalance: 85e5, offshoreBalance: 23e5, totalValue: 12e6, ytdReturn: 8.4, relationshipManager: "Victoria Langley", onboardedDate: "2024-03-01", impactCategory: "Social Welfare", location: "London, UK", ukGifts: 12, overseasGifts: 5, assetTypes: ["Cash", "Shares", "Property"], hasInvestmentAccount: true, investmentProvider: "Goldman Sachs", accountManager: "Patricia Gresham", giftEligible: true, donorCount: 4 },
  ...
  { id: "ca10", name: "Thornbury Impact Fund", accountNumber: "CF-2024-0018", accountType: "Collective Fund", entity: "TPCT", status: "Active", cashBalance: 42e4, investmentBalance: 31e5, offshoreBalance: 68e4, totalValue: 42e5, ytdReturn: 6.5, relationshipManager: "Sophie Merrick", onboardedDate: "2024-09-01", impactCategory: "Social Welfare", location: "Manchester, UK", ukGifts: 6, overseasGifts: 2, assetTypes: ["Cash", "Shares"], hasInvestmentAccount: true, investmentProvider: "Brewin Dolphin", accountManager: "Fund Committee", giftEligible: true, donorCount: 5 },
  { id: "ca11", name: "Ashford Legacy Fund", accountNumber: "DAF-2024-0029", accountType: "DAF", entity: "PAL", status: "Active", cashBalance: 18e4, investmentBalance: 23e5, offshoreBalance: 0, totalValue: 248e4, ytdReturn: 5.3, relationshipManager: "Victoria Langley", onboardedDate: "2024-05-20", impactCategory: "Environment", location: "London, UK", ukGifts: 3, overseasGifts: 0, assetTypes: ["Cash", "Shares"], hasInvestmentAccount: true, investmentProvider: "Cazenove Capital", accountManager: "Edward Langley", giftEligible: true, donorCount: 1 },
  { id: "ca12", name: "Penrose Wealth CF", accountNumber: "CF-2025-0022", accountType: "Collective Fund", entity: "TPCT", status: "Active", cashBalance: 6e5, investmentBalance: 48e5, offshoreBalance: 9e5, totalValue: 63e5, ytdReturn: 7.1, relationshipManager: "Victoria Langley", onboardedDate: "2025-01-10", impactCategory: "International Development", location: "London, UK", ukGifts: 4, overseasGifts: 5, assetTypes: ["Cash", "Shares", "Property"], hasInvestmentAccount: true, investmentProvider: "Brewin Dolphin", accountManager: "Fund Manager", giftEligible: true, donorCount: 8 },
...
const adminGrants = [
  { id: "g1", grantName: "Annual Support Grant", charity: "NSPCC", charityNumber: "216401", amount: 25e4, stage: "Paid", issueArea: "Children & Young People", priority: "High", ddStatus: "Complete", clientAccount: "Cavendish-Hale Foundation Fund", requestedBy: "Helena Cavendish-Hale", dateRequested: "2026-01-10", daysInStage: 0 },
  { id: "g2", grantName: "Restoration Fund", charity: "Tate Foundation", charityNumber: "1085314", amount: 175e3, stage: "Approved", issueArea: "Arts & Culture", priority: "Medium", ddStatus: "Complete", clientAccount: "Ashworth Arts & Heritage Fund", requestedBy: "Lady Sophia Ashworth", dateRequested: "2026-02-01", daysInStage: 14 },
  { id: "g3", grantName: "Research Programme Grant", charity: "British Heart Foundation", charityNumber: "225971", amount: 5e5, stage: "In Review", issueArea: "Health & Medical", priority: "High", ddStatus: "Complete", clientAccount: "Westminster Giving Fund", requestedBy: "Trust Committee", dateRequested: "2026-02-15", daysInStage: 23 },
  { id: "g4", grantName: "Conservation Programme", charity: "WWF UK", charityNumber: "1081247", amount: 35e4, stage: "Paid", issueArea: "Environment", priority: "High", ddStatus: "Complete", clientAccount: "Cavendish-Hale Foundation Fund", requestedBy: "Helena Cavendish-Hale", dateRequested: "2025-06-01", daysInStage: 0 },
  { id: "g5", grantName: "Performance Season Support", charity: "Royal Opera House", charityNumber: "211775", amount: 12e4, stage: "Awaiting Bank Statement", issueArea: "Arts & Culture", priority: "Medium", ddStatus: "In Progress", clientAccount: "Ashworth Arts & Heritage Fund", requestedBy: "Lady Sophia Ashworth", dateRequested: "2026-02-20", daysInStage: 18 },
  { id: "g6", grantName: "Scholarships Fund", charity: "Eton College Foundation", charityNumber: "1139086", amount: 2e5, stage: "Approved", issueArea: "Education", priority: "Medium", ddStatus: "Complete", clientAccount: "Ellsworth Research Fund", requestedBy: "Professor Diana Ellsworth", dateRequested: "2026-01-20", daysInStage: 21 },
  { id: "g7", grantName: "Emergency Relief Fund", charity: "British Red Cross", charityNumber: "220949", amount: 1e5, stage: "Paid", issueArea: "Humanitarian", priority: "High", ddStatus: "Complete", clientAccount: "Beaumont Charitable Fund", requestedBy: "Catherine Beaumont", dateRequested: "2026-01-05", daysInStage: 0 },
  { id: "g8", grantName: "Community Kitchen", charity: "The Felix Project", charityNumber: "1168183", amount: 45e3, stage: "First Contact", issueArea: "Poverty & Food", priority: "Low", ddStatus: "Pending", clientAccount: "Thornbury Impact Fund", requestedBy: "Fund Committee", dateRequested: "2026-03-01", daysInStage: 9 },
  { id: "g9", grantName: "Mental Health Programme", charity: "Mind", charityNumber: "219830", amount: 28e4, stage: "In Review", issueArea: "Health & Medical", priority: "High", ddStatus: "In Progress", clientAccount: "Ashford Legacy Fund", requestedBy: "Trust Manager", dateRequested: "2026-02-10", daysInStage: 28 },
  { id: "g10", grantName: "Literacy Programme", charity: "National Literacy Trust", charityNumber: "1116260", amount: 85e3, stage: "Requested", issueArea: "Education", priority: "Medium", ddStatus: "Not Started", clientAccount: "Ellsworth Research Fund", requestedBy: "Professor Diana Ellsworth", dateRequested: "2026-03-05", daysInStage: 5 },
  { id: "g11", grantName: "Ocean Conservation", charity: "Marine Conservation Society", charityNumber: "1004005", amount: 15e4, stage: "Approved", issueArea: "Environment", priority: "Medium", ddStatus: "Complete", clientAccount: "Penrose Wealth CF", requestedBy: "Fund Committee", dateRequested: "2026-01-25", daysInStage: 18 },
  { id: "g12", grantName: "Youth Orchestra Support", charity: "National Youth Orchestra", charityNumber: "263878", amount: 6e4, stage: "Paid", issueArea: "Arts & Culture", priority: "Low", ddStatus: "Complete", clientAccount: "Ashworth Arts & Heritage Fund", requestedBy: "Lady Sophia Ashworth", dateRequested: "2025-03-15", daysInStage: 0 },
  { id: "g13", grantName: "Homelessness Prevention", charity: "Shelter", charityNumber: "263710", amount: 19e4, stage: "In Review", issueArea: "Housing", priority: "High", ddStatus: "Complete", clientAccount: "Thornbury Impact Fund", requestedBy: "Fund Committee", dateRequested: "2026-02-05", daysInStage: 33 },
  { id: "g14", grantName: "Reforestation Project", charity: "Woodland Trust", charityNumber: "294344", amount: 95e3, stage: "First Contact", issueArea: "Environment", priority: "Medium", ddStatus: "Not Started", clientAccount: "Beaumont Charitable Fund", requestedBy: "Catherine Beaumont", dateRequested: "2026-03-03", daysInStage: 7 },
  { id: "g15", grantName: "Cancer Research Grant", charity: "Cancer Research UK", charityNumber: "1089464", amount: 4e5, stage: "Requested", issueArea: "Health & Medical", priority: "High", ddStatus: "Not Started", clientAccount: "Kensington Collective Fund", requestedBy: "Trust Committee", dateRequested: "2026-03-08", daysInStage: 2 },
  { id: "g16", grantName: "Museum Acquisition Fund", charity: "Victoria & Albert Museum", charityNumber: "312058", amount: 75e3, stage: "Declined", issueArea: "Arts & Culture", priority: "Low", ddStatus: "Failed", clientAccount: "Ashworth Arts & Heritage Fund", requestedBy: "Lady Sophia Ashworth", dateRequested: "2026-01-15", daysInStage: 54 }
];
const bdActivities = [
...
const quarterlyKPIs = [
  {
    ...
    conversionRates: {
      meetingsToLunchAndLearns: 14.3,
      meetingsToReferrals: 17.9,
      lunchAndLearnsToClients: 25,
      overallMeetingsToClients: 10.7,
      conversionPaths: [
  ...
  },
  {
    ...
    conversionRates: {
      meetingsToLunchAndLearns: 14.3,
      meetingsToReferrals: 20,
      lunchAndLearnsToClients: 40,
      overallMeetingsToClients: 11.4,
      conversionPaths: [
  ...
  },
  {
    ...
    conversionRates: {
      meetingsToLunchAndLearns: 13.6,
      meetingsToReferrals: 18.2,
      lunchAndLearnsToClients: 33.3,
      overallMeetingsToClients: 9.1,
      conversionPaths: [
  ...
  },
  {
    ...
    conversionRates: {
      meetingsToLunchAndLearns: 19.4,
      meetingsToReferrals: 19.4,
      lunchAndLearnsToClients: 33.3,
      overallMeetingsToClients: 16.1,
      conversionPaths: [
  ...
  },
  {
    ...
    conversionRates: {
      meetingsToLunchAndLearns: 15.8,
      meetingsToReferrals: 21.1,
      lunchAndLearnsToClients: 33.3,
      overallMeetingsToClients: 15.8,
      conversionPaths: [
...
function getAdminGrants() {
  return adminGrants;
}
function getBDActivities() {
  return bdActivities;
}
function getQuarterlyKPIs() {
...
function computeReminderStatus(nextReminderDate) {
  const today = /* @__PURE__ */ new Date();
  today.setHours(0, 0, 0, 0);
  const reminder = new Date(nextReminderDate);
  reminder.setHours(0, 0, 0, 0);
  const diffDays = Math.floor((reminder.getTime() - today.getTime()) / (1e3 * 60 * 60 * 24));
...
function daysBetween(dateA, dateB) {
  ...
  return Math.floor(Math.abs(b.getTime() - a.getTime()) / (1e3 * 60 * 60 * 24));
}
const TAG_COLORS = {
...
export { TAG_COLORS as T, formatCurrencyFull as a, formatCurrency as b, computeReminderStatus as c, daysBetween as d, getQuarter as e, formatDate as f, getQuarterlyKPIs as g, loadAdminData as l };
