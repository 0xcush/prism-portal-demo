...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_DJXz58Ps.mjs';
import { manifest } from './manifest_3zsGgL-C.mjs';
...
const _page13 = () => import('./pages/auth/callback.astro.mjs');
const _page14 = () => import('./pages/dashboard.astro.mjs');
const _page15 = () => import('./pages/grantee/dashboard.astro.mjs');
const _page16 = () => import('./pages/grantee/documents.astro.mjs');
const _page17 = () => import('./pages/grantee/payments.astro.mjs');
const _page18 = () => import('./pages/grantee.astro.mjs');
const _page19 = () => import('./pages/grants/_id_.astro.mjs');
const _page20 = () => import('./pages/grants.astro.mjs');
const _page21 = () => import('./pages/investments.astro.mjs');
const _page22 = () => import('./pages/login.astro.mjs');
const _page23 = () => import('./pages/resources.astro.mjs');
const _page24 = () => import('./pages/statements.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/auth/callback.astro", _page13],
    ["src/pages/dashboard.astro", _page14],
    ["src/pages/grantee/dashboard.astro", _page15],
    ["src/pages/grantee/documents.astro", _page16],
    ["src/pages/grantee/payments.astro", _page17],
    ["src/pages/grantee/index.astro", _page18],
    ["src/pages/grants/[id].astro", _page19],
    ["src/pages/grants.astro", _page20],
    ["src/pages/investments.astro", _page21],
    ["src/pages/login.astro", _page22],
    ["src/pages/resources.astro", _page23],
    ["src/pages/statements.astro", _page24],
