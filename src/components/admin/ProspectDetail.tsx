    ...
    <SlidePanel open={open} onClose={onClose} title={prospect.name} subtitle={prospect.referringFirm ? `via ${prospect.referringFirm}` : undefined}>
      ...
      <section className="mb-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <span className="text-sm text-slate-500">DAF Size</span>
            <span className="text-sm font-semibold text-slate-800">{formatCurrencyFull(prospect.dafSize)}</span>
          </div>
          <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-between">
            <span className="text-sm text-slate-500">BD Point of Contact</span>
            <span className="text-sm text-slate-700">{prospect.bdPointOfContact}</span>
          </div>
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm text-slate-700">{prospect.impactCategory || 'N/A'}</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-slate-500">
              <span className="inline-flex items-center gap-1">
            ...
            <span className="text-sm text-slate-700">{prospect.location || 'N/A'}</span>
          </div>
          <div className="flex items-center justify-between">
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
          <div className="grid grid-cols-2 gap-x-6 gap-y-4">
            <div>
              ...
              <span className="text-sm font-medium text-slate-900">{prospect.ukGifts ?? 'N/A'}</span>
            </div>
            <div>
              <div className="flex items-center gap-1.5 mb-1">
                <svg className="w-3.5 h-3.5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
              ...
              <span className="text-sm font-medium text-slate-900">{prospect.overseasGifts ?? 'N/A'}</span>
            </div>
            <div>
              <div className="flex items-center gap-1.5 mb-1">
                <svg className="w-3.5 h-3.5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
              ...
              <span className="text-sm font-medium text-slate-900">{prospect.assetTypes?.join(', ') || 'N/A'}</span>
            </div>
            <div>
              <div className="flex items-center gap-1.5 mb-1">
                <svg className="w-3.5 h-3.5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
              ...
              <span className="text-sm font-medium text-slate-900">{prospect.hasInvestmentAccount ? 'Yes' : 'No'}</span>
            </div>
            {prospect.hasInvestmentAccount && (
              <>
                <div>
                  <div className="flex items-center gap-1.5 mb-1">
                    <svg className="w-3.5 h-3.5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                  ...
                  <span className="text-sm font-medium text-slate-900">{prospect.investmentProvider || 'N/A'}</span>
                </div>
                <div>
                  <div className="flex items-center gap-1.5 mb-1">
                    <svg className="w-3.5 h-3.5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                  ...
                  <span className="text-sm font-medium text-slate-900">{prospect.accountManager || 'N/A'}</span>
                </div>
              </>
            )}
            <div>
              ...
              <span className="text-sm font-medium text-slate-900">{prospect.giftEligible != null ? (prospect.giftEligible ? 'Yes' : 'No') : 'N/A'}</span>
            </div>
            <div>
              <div className="flex items-center gap-1.5 mb-1">
                <svg className="w-3.5 h-3.5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
              ...
              <span className="text-sm font-medium text-slate-900">{prospect.donorCount ?? 'N/A'}</span>
            </div>
          </div>
        </div>
      </section>
